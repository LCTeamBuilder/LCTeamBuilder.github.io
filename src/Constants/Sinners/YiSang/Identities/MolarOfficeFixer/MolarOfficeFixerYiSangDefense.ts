...
export class MolarOfficeFixerYiSangDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/YiSang/MolarOfficeFixer/GuardUT4.png";
}