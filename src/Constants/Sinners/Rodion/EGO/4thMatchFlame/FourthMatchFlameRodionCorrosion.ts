...
export class FourthMatchFlameRodionCorrosion implements Skill{
    ...
    readonly SkillImageDir: string = "./assets/Sinners/Rodion/EGO/4thMatchFlame/20902erosionprofile.png";
}