...
export class District20YurodivyHongLuDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/HongLu/District20Yurodivy/Wait.png";
}