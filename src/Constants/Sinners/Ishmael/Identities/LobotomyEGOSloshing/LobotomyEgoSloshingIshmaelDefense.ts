...
export class LobotomyEgoSloshingIshmaelDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Ishmael/LobotomyEGOSloshing/GuardUT4.png";
}