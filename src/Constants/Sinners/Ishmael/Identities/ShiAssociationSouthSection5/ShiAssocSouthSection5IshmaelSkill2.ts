...
export class ShiAssocSouthSection5IshmaelSkill2 implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Ishmael/ShiAssociationSouthSection5/FlashingStrike.png";
}