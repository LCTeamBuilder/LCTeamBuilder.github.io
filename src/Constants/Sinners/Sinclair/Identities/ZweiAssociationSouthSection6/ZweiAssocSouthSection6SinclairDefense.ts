...
export class ZweiAssocSouthSection6SinclairDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Sinclair/ZweiAssociationSouthSection6/GuardUT4.png";
}