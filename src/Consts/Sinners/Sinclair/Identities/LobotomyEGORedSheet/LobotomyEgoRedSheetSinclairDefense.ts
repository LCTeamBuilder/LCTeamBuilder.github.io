...
export class LobotomyEgoRedSheetSinclairDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Sinclair/LobotomyEGORedSheet/GuardUT4.png";
}