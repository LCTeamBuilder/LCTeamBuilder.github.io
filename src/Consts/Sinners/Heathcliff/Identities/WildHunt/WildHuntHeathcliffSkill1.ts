...
export class WildHuntHeathcliffSkill1 implements Skill {
    readonly Name: string = "Beheading";
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Heathcliff/WildHunt/Beheading.png";
}