...
export class WCorpL3CleanupAgentYiSangDefense implements Skill {
    readonly Name: string = "Hollow Dimension";
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/YiSang/WCorpL3CleanupAgent/HollowDimensionUT4.png";
}