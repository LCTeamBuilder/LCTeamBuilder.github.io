...
export class TingtangGangGangleaderHongLuDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/HongLu/TingtangGangGangleader/EvadeUT4.png";
}