...
export class FanghuntOfficeFixerHongLuDefense implements Skill {
    readonly Name: string = "Emergency Styptics";
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/HongLu/FanghuntOfficeFixer/EmergencyStypticsUT4.png";
}