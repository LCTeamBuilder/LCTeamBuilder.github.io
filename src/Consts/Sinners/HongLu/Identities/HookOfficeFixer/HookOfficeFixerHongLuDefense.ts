...
export class HookOfficeFixerHongLuDefense implements Skill {
    readonly Name: string = "Quickness";
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/HongLu/HookOfficeFixer/QuicknessUT4.png";
}