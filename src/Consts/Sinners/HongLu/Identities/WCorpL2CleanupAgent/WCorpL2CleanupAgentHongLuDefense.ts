...
export class WCorpL2CleanupAgentHongLuDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/HongLu/WCorpL2CleanupAgent/GuardUT4.png";
}