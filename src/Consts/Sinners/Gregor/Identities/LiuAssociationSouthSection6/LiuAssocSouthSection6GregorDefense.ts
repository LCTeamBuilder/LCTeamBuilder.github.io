...
export class LiuAssocSouthSection6GregorDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Gregor/LiuAssocSouthSection6/GuardUT4.png";
}