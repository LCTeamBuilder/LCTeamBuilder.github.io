...
export class ZweiAssocSouthSection4FaustDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Faust/ZweiAssociationSouthSection4/GuardUT4.png";
}