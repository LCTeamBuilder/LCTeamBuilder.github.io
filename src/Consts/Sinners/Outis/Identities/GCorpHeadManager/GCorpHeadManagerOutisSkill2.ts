...
export class GCorpHeadManagerOutisSkill2 implements Skill {
    readonly Name: string = "Onslaught Command";
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Outis/GCorpHeadManager/OnslaughtCommand.png";
}