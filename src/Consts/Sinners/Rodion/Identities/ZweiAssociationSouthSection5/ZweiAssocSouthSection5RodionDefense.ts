...
export class ZweiAssocSouthSection5RodionDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Rodion/ZweiAssociationSouthSection5/GuardUT4.png";
}