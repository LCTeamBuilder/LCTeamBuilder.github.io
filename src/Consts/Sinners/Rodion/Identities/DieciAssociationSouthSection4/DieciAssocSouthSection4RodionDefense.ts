...
export class DieciAssocSouthSection4RodionDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Rodion/DieciAssociationSouthSection4/FixatedStudyUT4.png";
}