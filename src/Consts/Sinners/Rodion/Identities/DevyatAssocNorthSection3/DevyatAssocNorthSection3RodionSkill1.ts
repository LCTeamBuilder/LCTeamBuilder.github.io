...
export class DevyatAssocNorthSection3RodionSkill1 implements Skill {
    ...
    readonly SkillDescription: SkillDescriptionPart[] = 
        [new SkillDescriptionPart("Coin Power +1 for every 10 [Courier Trunk] on self or for every 6 [Rupture] on the target (max 2)<br>"+
        ...
        new SkillDescriptionPart("[On Hit] Gain 1 [Courier Trunk]<br>"+
            "- If this unit has less than 15 [Courier Trunk], gain 1 additional [Courier Trunk]", 1),
