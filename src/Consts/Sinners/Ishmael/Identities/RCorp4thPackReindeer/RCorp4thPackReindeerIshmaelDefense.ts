...
export class RCorp4thPackReindeerIshmaelDefense implements Skill {
    ...
    readonly SkillImageDir: string = "assets/Icons/Skills/Sinners/Ishmael/RCorp4thPackReindeer/Evade.png";
}